...
exec "Snippet class class ".st."name".et." {<CR>public:<CR>".st."name".et." (".st."arguments".et.");<CR>virtual ~".st."name".et."();<CR><CR>private:<CR>".st.et."<CR>};<CR>".st.et
...
exec "Snippet struct struct ".st."name".et." {<CR>".st.et."<CR>};<CR>".st.et
